...
export function NameCard({ label }: FloatItemContentProps) {
  return (
    ...
    >
      <path d="M 175,15 L 175,-15 L 225,-15 L 225,15" strokeWidth={8} />
      <path d="M 20,15 L 380,15 L 380,165 L 20,165 Z" strokeWidth={8} />
      <circle cx="95" cy="75" r="20" strokeWidth={6} />
      <path d="M 60,135 A 40 40 0 0 1 130,135" strokeWidth={6} />
    </FloatIcon>
  );
}
